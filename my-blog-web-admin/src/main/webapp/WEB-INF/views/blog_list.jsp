            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <a href="/blog/form1" type="button" class="btn btn-sm btn-primary" style="margin-left: 25px"><i class="fa fa-plus"></i>&nbsp;发布博客</a>
                            <div class="col-md-10 pull-right">
                                <div class="row pull-right">
                                   <div class="col-md-8"><input type="text" class="form-control form-group-sm" id = "keyword" placeholder="请输入关键字"/></div>
