...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right custom-menu" id="mynav">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p style="color: #0a001f">
                                    ${blogger.username}
                                    <small class="hidden-xs">${blogger.email}</small>
                                    <small><fmt:formatDate value="${blogger.created}" pattern="yyyy-MM-dd HH:mm:ss"/></small>
                                </p>
                            </li>
                            <li class="user-body">
                                <p>
